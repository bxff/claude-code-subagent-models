...
```bash
npx claude-code-providers /path/to/claude claude-patched.js
...
[npm](https://www.npmjs.com/package/claude-code-providers) · [GitHub](https://github.com/bxff/claude-code-providers)
