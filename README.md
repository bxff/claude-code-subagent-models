...
```bash
npx claude-code-hybrid-router /path/to/claude claude-patched.js
...
[npm](https://www.npmjs.com/package/claude-code-hybrid-router) · [GitHub](https://github.com/bxff/claude-code-hybrid-router)
